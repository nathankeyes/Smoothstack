...
public class AsciiArt {
	...
	void designOne(int rowNum) {
		...
		for (int i = 0; i < rowNum; i++) {
			...
			// reset to current line number and print additional asterics for additional
			// lines
			int j = i;
			while (j >= 0) {
				System.out.print("*");
	...
	void designTwo(int rowNum) {
		...
		for (int i = 0; i < rowNum; i++) {
			...
			// reset to max number of lines minus our current line number to decrease number
			// of prints
			int j = rowNum - i;
