...
public class AppendText {
	...
	// not sure what it is, but i moved the scan into main function and happen
	// before the path call and it started working
	// truly no idea, COME BACK TO FIX
	// ************************************************
	/*
	 * public String NewMessage() throws IOException { String messageString;
	 * 
	 ...
	 * 
	 * 
	 * return messageString; } catch ( Exception e ) { e.printStackTrace(); return
	 * null; } }
	 */
	...
	public Path ReadInPath() throws IOException {
		...
		try (Scanner scan = new Scanner(System.in)) {
			...
			// file input type stuff, couldn't get it to work so just checking if file
			// exists or not, will have to come back
			/*
			 * System.out.println("File type: " + Files.probeContentType(filePath));
			 * 
			 * if ( Files.probeContentType(filePath) != "text/plain") {
			 * System.out.print("Incorrect file type for appending, try again"); return
			 * null; }
			 */
	...
	public static void main(String[] args) throws IOException {
		...
		// some reason my scan refused to work after the scan reading in the path, so i
		// had to just put this here
