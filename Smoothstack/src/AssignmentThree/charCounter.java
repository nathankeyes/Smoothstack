 ...
 * @DateCreated 3/11/21
 * @LastEdited 3/11/21
 * @Description Write an example that counts the number of times a particular
 *              character, such as 'e', appears in a file - character can be
 *              specified at the command line - path to text file can be
 *              hardcoded
 */
