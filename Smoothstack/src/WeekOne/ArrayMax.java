 ...
 * @DateCreated 3/10/21
 * @LastEdited  3/10/21
 * @Description Construct a 2D array and find the max number, and show it's position in array
 */
		...
		for ( int i = 0; i < array.length; i++ ) {
			for ( int j = 0; j < array[0].length; j++ ) {
				if ( array[i][j] > max ) {
					...
					// chose to do two int values to save index because creating another 2D array would be a large memory usage
